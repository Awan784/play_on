    ...
    <section class="dashboard">
        <div class="container-fluid">
            ...
            <div class="row border shadow p-2" style="background-color: white; height: auto; width: 100%; margin: 0px 0px 15px;">
                <a href="{{ route('admin.permissions.edit', 0) }}"><button class="btn btn-success">Add New Permission</button></a>
                        ...
                        <tbody>
                            @forelse($permissions as $key => $value)
                                <tr>
                                    ...
                                    <td class="width-20">
                                        <a href="{{ route('admin.permissions.edit', $value->id) }}" title="Edit"><i class="fa fa-edit"></i></a>
                                        <a href="javascript:{};" data-url="{{ route('admin.permissions.destroy',  $value->id) }}" title="Delete" class="delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
